...
function OnWorldPreUpdate()
	...
	if open and not inventory_open then
		...
		if tooltip_wand then
			...
			GuiText(gui, 0, margin, ("%.2f s"):format(wand.props.castDelay / 60))
			GuiText(gui, 0, margin, ("%.2f s"):format(wand.props.rechargeTime / 60))
			GuiText(gui, 0, margin, ("%.0f"):format(wand.props.manaMax))
			GuiText(gui, 0, margin, ("%.0f"):format(wand.props.manaChargeSpeed))
			GuiText(gui, 0, margin, ("%.0f"):format(wand.props.capacity))
